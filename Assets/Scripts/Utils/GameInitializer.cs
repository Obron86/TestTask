...
namespace Utils
{
    public class GameInitializer : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            _gameController.Initialize(_playerController, _vfxController, gameOverPanel, timerText, restartButton, settings);
            _playerController.Initialize(_floor, touchJoystick, settings);
            _mineSpawner.Initialize(_floor, minePrefab, _gameController.GameModel.mineCount);
            _enemySpawner.Initialize(_gameController, _floor, enemyPrefab, _playerController, settings);
